...
export const CONTACT_PAGE_UNLOADED = 'CONTACT_PAGE_UNLOADED';

/* DEVICE */
export const DEVICE_PAGE_LOADED = 'DEVICE_PAGE_LOADED';
export const DEVICE_PAGE_UNLOADED = 'DEVICE_PAGE_UNLOADED';
export const HOME_OFFERS = "HOME_OFFERS";
